...
for it in range(train_iter):
    ...
    loss_gw = rarisgw_gpu(D_x_norm.to('cuda'), D_g_norm.to('cuda') ,'cuda' ,nproj=500,P=None,lr=0.001, max_iter=20, verbose=False, step_verbose=10, tolog=False, retain_graph=True)
