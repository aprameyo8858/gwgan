...
for it in range(train_iter):
    ...
    loss_gw=risgw_gpu_original(D_x_norm.to('cuda'), D_g_norm.to('cuda') ,'cuda' ,nproj=500,P=None,lr=0.001, max_iter=50, verbose=False, step_verbose=10, tolog=False, retain_graph=True)
    if it < only_g:
        # train generator
        if l1_reg:
